  ...
  return <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-14">
    ...
    <header className={`relative mt-7 overflow-hidden rounded-[30px] border shadow-card ${visual.card}`}>
      ...
      <div className="grid gap-8 p-6 sm:p-8 lg:grid-cols-[1fr_auto] lg:items-start">
        ...
        <div className="flex flex-wrap gap-2"><a href={skill.package.path} download className={`inline-flex h-11 items-center gap-2 rounded-full px-5 text-sm font-semibold text-white transition ${visual.button}`}><Download className="h-4 w-4" />下载</a></div>
      </div>
